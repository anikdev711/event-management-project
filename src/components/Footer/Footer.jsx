    ...
    return (
        <div>
            <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
                <nav className="grid grid-flow-col gap-4 text-2xl font-semibold">
                    Follow us on
                </nav>
                <nav>
                    ...
                    <div className='flex items-center justify-center mx-auto gap-5 mt-8'>
                        <div className='flex items-center gap-2 pr-5 border-r-2 border-black'>
                            <AiTwotoneMail></AiTwotoneMail>
                            <p>info@eduquestevents.net</p>
                        </div>
                ...
                <aside>
                    <p>Copyright © 2023 - All right reserved by EduQuest Events</p>
                </aside>
            </footer>
        </div>
    );
